		...
		switch (type) {
			...
			case "midiID": {
				message = div(
					...
					p("1 - Bright Acoustic Piano"),
					p("2 - Electric Grand Piano"),
					p("3 - Honky-tonk Piano"),
					p("4 - Electric Piano 1"),
					p("5 - Electric Piano 2"),
					p("6 - Harpsichord"),
					p("7 - Clavinet"),
					p("8 - Celesta"),
					p("9 - Glockenspiel"),
					...
					p("15 - Dulcimer"),
					p("16 - Drawbar Organ"),
					p("17 - Percussive Organ"),
					p("18 - Rock Organ"),
					p("19 - Church Organ"),
					p("20 - Reed Organ"),
					p("21 - Accordion"),
					p("22 - Harmonica"),
					p("23 - Tango Accordion"),
					p("24 - Acoustic Guitar (nylon)"),
					p("25 - Acoustic Guitar (steel)"),
					p("26 - Electric Guitar (jazz)"),
					p("27 - Electric Guitar (clean)"),
					p("28 - Electric Guitar (muted)"),
					p("29 - Overdriven Guitar"),
					p("30 - Distortion Guitar"),
					p("31 - Guitar harmonics"),
					p("32 - Acoustic Bass"),
					p("33 - Electric Bass (finger)"),
					p("34 - Electric Bass (pick)"),
					p("35 - Fretless Bass"),
					p("36 - Slap Bass 1"),
					p("37 - Slap Bass 2"),
					p("38 - Synth Bass 1"),
					...
					p("42 - Cello"),
					p("43 - Contrabass"),
					p("44 - Tremolo Strings"),
					p("45 - Pizzicato Strings"),
					p("46 - Orchestral Harp"),
					p("47 - Timpani"),
					p("48 - String Ensemble 1"),
					p("49 - String Ensemble 2"),
					p("50 - Synth Strings 1"),
					p("51 - Synth Strings 2"),
					p("52 - Choir Aahs"),
					p("53 - Voice Oohs"),
					p("54 - Synth Voice"),
					p("55 - Orchestra Hit"),
					...
					p("79 - Ocarina"),
					p("80 - Lead 1 (square)"),
					p("81 - Lead 2 (sawtooth)"),
					p("82 - Lead 3 (calliope)"),
					p("83 - Lead 4 (chiff)"),
					p("84 - Lead 5 (charang)"),
					p("85 - Lead 6 (voice)"),
					p("86 - Lead 7 (fifths)"),
					p("87 - Lead 8 (bass + lead)"),
					p("88 - Pad 1 (new age)"),
					p("89 - Pad 2 (warm)"),
					p("90 - Pad 3 (polysynth)"),
					p("91 - Pad 4 (choir)"),
					p("92 - Pad 5 (bowed)"),
					p("93 - Pad 6 (metallic)"),
					p("94 - Pad 7 (halo)"),
					p("95 - Pad 8 (sweep)"),
					p("96 - FX 1 (rain)"),
					p("97 - FX 2 (soundtrack)"),
					p("98 - FX 3 (crystal)"),
					p("99 - FX 4 (atmosphere)"),
					p("100 - FX 5 (brightness)"),
					p("101 - FX 6 (goblins)"),
					p("102 - FX 7 (echoes)"),
					p("103 - FX 8 (sci-fi)"),
					p("104 - Sitar"),
					...
					p("117 - Melodic Tom"),
					p("118 - Synth Drum"),
					p("119 - Reverse Cymbal"),
					p("120 - Guitar Fret Noise"),
					p("121 - Breath Noise"),
					p("122 - Seashore"),
					p("123 - Bird Tweet"),
					p("124 - Telephone Ring"),
					p("125 - Helicopter"),
					p("126 - Applause"),
					p("127 - Gunshot"),
					p("128 - High Q"),
					...
					p("132 - Sticks"),
					p("133 - Square Click"),
					p("134 - Metronome Click"),
					p("135 - Metronome Bell"),
					p("136 - Bass Drum 2"),
					p("137 - Bass Drum 1"),
					p("138 - Side Stick"),
					p("139 - Snare Drum 1"),
					...
					p("148 - Mid Tom 1"),
					p("149 - High Tom 2"),
					p("150 - Crash Cymbal 1"),
					p("151 - High Tom 1"),
					p("152 - Ride Cymbal 1"),
					p("153 - Chinese Cymbal"),
					p("154 - Ride Bell"),
					p("155 - Tambourine"),
					p("156 - Splash Cymbal"),
					p("157 - Cowbell"),
					p("158 - Crash Cymbal 2"),
					p("159 - Vibra Slap"),
					p("160 - Ride Cymbal 2"),
					p("161 - High Bongo"),
					p("162 - Low Bongo"),
					p("163 - Mute High Conga"),
					p("164 - Open High Conga"),
					p("165 - Low Conga"),
					p("166 - High Timbale"),
					p("167 - Low Timbale"),
					p("168 - High Agogo"),
					...
					p("175 - Long Guiro"),
					p("176 - Claves"),
					p("177 - High Wood Block"),
					p("178 - Low Wood Block"),
					p("179 - Mute Cuica"),
					p("180 - Open Cuica"),
					p("181 - Mute Triangle"),
					p("182 - Open Triangle"),
